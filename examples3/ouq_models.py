...
def sample(model, bounds, pts=None, **kwds):
    ...
    Inputs:
        ...
        pts: int, number of samples to draw; if negative, number of solvers
    ...
    NOTE:
        a negative pts (i.e. pts=-4) uses optimizer-directed sampling
        starting points are generated by the sampler, and run until converged

    NOTE:
        dist is used to add randomness to the sampler
    """
