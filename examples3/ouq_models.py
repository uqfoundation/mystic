...
def sample(model, bounds, pts=None, **kwds):
    ...
    model is a cached model function
    bounds is a list of tuples of (lower,upper)
    pts is int, number of samples (pure sampling) or neg for trajectory solvers
    sampler is the mystic.sampler type
    solver is the mystic.solver type
    dist is a distribution type
...
class OUQModel(object): #NOTE: effectively, this is WrapModel
    ...
    def __init_func(self):
        # add function interface, and axis
