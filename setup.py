...
builtins.__MYSTIC_SETUP__ = True
sys.path.append(os.path.abspath(os.path.curdir))
import mystic

# get version numbers, long_description, etc
AUTHOR = mystic.__author__
VERSION = mystic.__version__
LONG_DOC = mystic.__doc__ #FIXME: near-duplicate of README.md
#LICENSE = mystic.__license__ #FIXME: duplicate of LICENSE
