...
Example:
    ...
    - Uses SparsitySolver to provide 'pseudo-global' optimization
...
if __name__ == '__main__':
    ...
    # use sparsity-Powell to solve 8th-order Chebyshev coefficients
    solver = SparsitySolver(ndim, npts, rtol=rtol)
