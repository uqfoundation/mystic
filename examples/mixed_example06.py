...
Example:
    ...
    - Uses MixedSolver to provide 'pseudo-global' optimization
...
"""
# the Mixed solver
from mystic.solvers import MixedSolver
...
if __name__ == '__main__':
    ...
    random_seed(123)
    ndim = 9
    samp = dict(lattice=[2,1,2,1,1,1,1,1,1], sparsity=(4,.1))
    ...
    # use mixed-Powell to solve 8th-order Chebyshev coefficients
